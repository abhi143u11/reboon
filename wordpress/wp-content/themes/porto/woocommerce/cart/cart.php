...
<div class="psa-continue-butt">
    <a href="#find"><i class="fa fa-cart-plus" aria-hidden="true"></i> Einkauf fortsetzen</a>
</div>
...
$(document).ready(function(){
        ...
        $("a.checkout-button.button.alt.wc-forward").addClass('cart-butt').append('<i class="Defaults-angle-right" style="margin-left:10px;font-size:18px;"></i>').insertAfter($(".shop_table.responsive.cart-total"));
        $("h1.page-title").addClass('cart-title');
