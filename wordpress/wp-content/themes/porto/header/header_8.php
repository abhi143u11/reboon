...
<header id="header" class="header-8 <?php echo $porto_settings['search-size'] ?><?php echo ($porto_settings['logo-overlay'] && $porto_settings['logo-overlay']['url']) ? ' logo-overlay-header' : '' ?>">
    ...
    <div class="header-main">
        <div class="container">
            ...
            <div class="header-center"> <!--wpdreams_ajaxsearchpro id=1 trd_searchPanelшорткод для поиска стандартного. Потом можно удалить--> 
                <div class="psa-search trd_search_wrap"><?php echo do_shortcode('[trd_searchPanel]'); ?></div>
            </div>
