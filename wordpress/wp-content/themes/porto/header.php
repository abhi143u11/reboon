...
<body <?php body_class(array($body_class)); ?><?php echo $showing_overlay ? 'data-loading-overlay' : '' ?>>
    ...
    ?>
        ...
        <div class="container">
            Funktionale Hüllen für <?php echo $m ?> verschiedene Handys, Tablets und eBook Readder. <a href="#find">Finde deine hülle <i class="Defaults-angle-right" style="font-size:14px;"></i></a>
            <div class="devider-ps"></div>
            <p class="psa-right-topper"><span><i class="fa fa-globe" aria-hidden="true"></i> <a href="/haendlersuche/">HÄNDLERSUCHE</a></span> <span><i class="fa fa-truck" aria-hidden="true"></i></span> <a href="/shipping-methods/">
             KOSTENLOSER VERSAND</a></p>
        </div>
    </div>
