...
/*        if ( has_post_thumbnail( $variation->get_variation_id() ) ) {
    ...
    public function tm_list_column( $column,  $post_id ){
        switch ( $column ) {
            ...
            case "applied_on":
                ...
                $tm_meta_id= get_post_meta( $post_id , 'tm_meta_product_ids' , true );
    ...
    public function tm_product_search_meta_box($post){
        ...
        <?php if(version_compare( WC()->version, '2.3', '<' )){?>
            ...
            }elseif(version_compare( WC()->version, '2.3', '>=' )){?>
        ...
        if ($wpml_is_original_product){
            echo apply_filters('wc_epo_admin_tc_welcome','<div id="tc-welcome" class="tc-welcome"><div class="tc-logo"><span class="tm-logo-text"><span class="tm-logo-text-e">E</span><span class="tm-logo-text-po">PO</span></span></div>'
                ...
                .'<div class="tc-buttons">'
                    .'<a class="tm-animated tc-add-element tm-button button button-primary button-large tc-clearfix" title="'.__('Add element','woocommerce-tm-extra-product-options').'" href="#"><i class="ddd"></i>'.__('Add element','woocommerce-tm-extra-product-options').'</a>'
                    .'<a class="tm-animated tc-add-section tm-button button button-primary button-large tc-clearfix" title="'.__('Add section','woocommerce-tm-extra-product-options').'" href="#"><i class="ddd"></i>'.__('Add section','woocommerce-tm-extra-product-options').'</a>'
                    .'<a class="tm-animated builder_add_variation tm-hidden tm-button button button-primary button-large tc-clearfix" href="#"><i class="tcfa tcfa-bullseye"></i> '.__("Style variations",'woocommerce-tm-extra-product-options').'</a>'
                    .'<a class="tm-animated tc-add-import-csv tm-button button button-primary button-large tc-clearfix" title="'.__('Import CSV','woocommerce-tm-extra-product-options').'" href="#"><i class="ddd"></i>'.__('Import CSV','woocommerce-tm-extra-product-options').'</a>'
                .'</div>'
                .'</div>');
