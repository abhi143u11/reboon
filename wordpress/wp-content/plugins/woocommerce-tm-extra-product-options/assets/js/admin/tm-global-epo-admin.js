(function($) {
    ...
    $.tmEPOAdmin = {
        ...
        add_events: function() {
            ...
            $(document).on("click.cpf", ".builder_add_section_and_element,.tc-add-element", $.tmEPOAdmin.builder_add_section_and_element_onClick);
            // Variation button
            ...
            if (wp && wp.media) {
                ...
                $tm_upload_frame.on( 'select',function() {
                    ...
                    selection.each(function(attachment) {
                        ...
                        _this.val(options.url);console.log(options);
                    });
                });
                /*$tm_upload_frame.on('select', function() {
