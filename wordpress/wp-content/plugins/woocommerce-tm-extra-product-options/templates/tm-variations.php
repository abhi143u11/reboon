	...
	if ( ! empty( $available_variations ) ) {
		...
		foreach ( $attributes as $name => $options ){
			...
			if ( sizeof( $attributes ) == $loop ){
				echo '<a class="reset_variations" href="#reset">' . ((!empty(TM_EPO()->tm_epo_reset_variation_text))?TM_EPO()->tm_epo_reset_variation_text:__( 'Auswahl zurücksetzen', 'woocommerce-tm-extra-product-options' )) . '</a>';
			}								
		}
	}
