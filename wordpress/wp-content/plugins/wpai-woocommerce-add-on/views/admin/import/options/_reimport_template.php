									...
									<div style="margin-left: -4px;">
										<div class="input">						
											...
											<div class="input">
												...
												<label for="duplicate_indicator_pid"><?php _e('Order ID', 'wp_all_import_plugin' )?></label><br>
...
<div class="wpallimport-collapsed wpallimport-section">
	<div class="wpallimport-content-section">
		<div class="wpallimport-collapsed-header">	
			<h3><?php _e('Email Notifications for Customers', 'wp_all_import_plugin'); ?></h3>											
		</div>
		<div class="wpallimport-collapsed-content" style="padding: 0;">
			<div class="wpallimport-collapsed-content-inner">
				<div class="input">
					...
					<label for="do_not_send_order_notifications"><?php _e('Block email notifications during import', 'wp_all_import_plugin') ?></label>
					<a href="#help" class="wpallimport-help" title="<?php _e('If enabled, WP All Import will prevent WordPress from sending notification emails to customers when their orders are imported or updated.', 'wp_all_import_plugin') ?>" style="position:relative; top: 0;">?</a>							
				</div>	
			</div>
		</div>			
	</div>
