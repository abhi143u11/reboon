<div class="wpallimport-collapsed wpallimport-section closed">
	<div class="wpallimport-content-section" style="padding-bottom: 0;">
		<div class="wpallimport-collapsed-header" style="margin-bottom: 15px;">
			<h3><?php _e('Notes','wpai_woocommerce_addon_plugin');?></h3>	
		</div>
					...
					<tr>
						<td>
							...
							<!-- <div class="form-field wpallimport-radio-field wpallimport-clear">
								...
								<label for="notes_repeater_mode_fixed" style="width:auto;"><?php _e('Fixed Repeater Mode', 'wp_all_import_plugin') ?></label>						
							</div> -->	
							<table class="form-field wpallimport_variable_table" style="width:98%;">
									...
									<tr class="form-field">
										<td>
											<table style="width:100%;" cellspacing="5">
												<tr>
													<td colspan="2">
														<h4 style="margin-top:0;"><?php _e('Content', 'wp_all_import_plugin') ?></h4>
														<div class="input">
															<textarea name="pmwi_order[notes][<?php echo $i; ?>][content]" style="width: 100%;" class="rad4"><?php echo esc_attr($note['content']); ?></textarea>
														</div>
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td colspan="2">
														<h4><?php _e('Visibility', 'wp_all_import_plugin') ?></h4>
														<div class="form-field wpallimport-radio-field">
															...
															<label for="order_note_visibility_privat_<?php echo $i; ?>" style="width:auto;"><?php _e('Private note', 'wp_all_import_plugin') ?></label>				
														</div>
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibility_customer_<?php echo $i; ?>" style="width:auto;"><?php _e('Note to customer', 'wp_all_import_plugin') ?></label>				
														</div>							
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibilityy_xpath_<?php echo $i; ?>" style="width:auto;"><?php _e('Set with XPath', 'wp_all_import_plugin') ?></label>														
														</div>	
														...
														<div class="switcher-target-order_note_visibilityy_xpath_<?php echo $i; ?>">										
															<span class="wpallimport-slide-content" style="padding-left:0;">
																...
																<a href="#help" class="wpallimport-help" title="<?php _e('Use \'private\' or \'customer\'.', 'wp_all_import_plugin') ?>" style="position:relative; top:0px;">?</a>
															</span>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<label><?php _e('Username', 'wp_all_import_plugin'); ?></label>
														<div class="clear">
								...
								<tr class="form-field template">
									<td>
										<table style="width:100%;" cellspacing="5">
												...
												<td colspan="2">
													...
													<div class="input">
														<div class="form-field wpallimport-radio-field">
															...
															<label for="order_note_visibility_privat_ROWNUMBER" style="width:auto;"><?php _e('Private note', 'wp_all_import_plugin') ?></label>				
														</div>													
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibility_customer_ROWNUMBER" style="width:auto;"><?php _e('Note to customer', 'wp_all_import_plugin') ?></label>				
														</div>																				
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibilityy_xpath_ROWNUMBER" style="width:auto;"><?php _e('Set with XPath', 'wp_all_import_plugin') ?></label>														
														</div>	
														<span class="wpallimport-clear"></span>
											...
											<tr>
												<td>
													<h4><?php _e('Username', 'wp_all_import_plugin'); ?></h4>
													<div class="clear">
														<input type="text" name="pmwi_order[notes][ROWNUMBER][username]" value="" style="width:100%;"/>	
													</div>
												</td>
												<td>
													<h4><?php _e('Email', 'wp_all_import_plugin'); ?></h4>
													<div class="clear">
								...
								<tr class="wpallimport-row-actions" style="display:none;">
									<td colspan="2">					
										<a class="add-new-line" title="Add Another Note" href="javascript:void(0);" style="width:200px;"><?php _e("Add Another Note", "wp_all_import_plugin"); ?></a>
									</td>
								</tr>
							</table>							
						</td>
					...
					<div style="padding: 0px;" class="wpallimport-collapsed-content">										
						<div class="wpallimport-collapsed-content-inner">											
							...
							<div class="form-field wpallimport-radio-field wpallimport-clear pmxi_option">
								...
								<label for="notes_repeater_mode_variable_csv" style="width:auto;"><?php _e('Fixed Repeater Mode', 'wp_all_import_plugin') ?></label>	
								<div class="switcher-target-notes_repeater_mode_variable_csv wpallimport-clear" style="padding: 10px 0 10px 25px; overflow: hidden;">
									<span class="order-separator-label wpallimport-slide-content" style="padding-left:0;">	
										<label><?php _e('Multiple notes separated by', 'wp_all_import_plugin'); ?></label>						
							...
							<div class="form-field wpallimport-radio-field wpallimport-clear pmxi_option">
								...
								<label for="notes_repeater_mode_variable_xml" style="width:auto;"><?php _e('Variable Repeater Mode', 'wp_all_import_plugin') ?></label>
								<div class="switcher-target-notes_repeater_mode_variable_xml wpallimport-clear" style="padding: 10px 0 10px 25px; overflow: hidden;">
									<span class="wpallimport-slide-content" style="padding-left:0;">	
										<label style="width: 60px;"><?php _e('For each', 'wp_all_import_plugin'); ?></label>						
										...
										<label style="padding-left: 10px;"><?php _e('do...', 'wp_all_import_plugin'); ?></label>
									</span>
								</div>		
							</div>	
							<?php else: ?>
							...
							<div class="form-field input" style="padding-left: 20px;">
								<label class="order-separator-label" style="line-height: 30px;"><?php _e('Multiple notes separated by', 'wp_all_import_plugin'); ?></label>						
								<input type="text" class="short rad4 order-separator-input" name="pmwi_order[notes_repeater_mode_separator]" value="<?php echo esc_attr($post['pmwi_order']['notes_repeater_mode_separator']) ?>" style="width:10%; text-align: center;"/>
								<a href="#help" class="wpallimport-help" style="top:0px;left:8px;" original-title="For example, two notes would be imported like this 'Note 1|Note 2'">?</a>							
							</div>
							<?php endif; ?>	
