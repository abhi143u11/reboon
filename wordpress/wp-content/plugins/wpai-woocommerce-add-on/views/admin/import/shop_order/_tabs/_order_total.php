<div class="panel woocommerce_options_panel" id="order_total" style="display:none;">
	<div class="options_group hide_if_grouped" style="margin-top:10px;">															
		<div class="form-field wpallimport-radio-field">
			...
			<label for="order_total_logic_auto" style="width:auto;"><?php _e('Calculate order total automatically', 'wp_all_import_plugin') ?></label>														
		</div>	
		...
		<div class="form-field wpallimport-radio-field">
			...
			<label for="order_total_logic_manually" style="width:auto;"><?php _e('Set order total manually', 'wp_all_import_plugin') ?></label>														
		</div>	
		<span class="wpallimport-clear"></span>
