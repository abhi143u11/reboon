	...
	<div class="options_group hide_if_grouped">																						
		<div class="input">
			<div class="form-field wpallimport-radio-field">
				...
				<label for="billing_source_existing" style="width:auto;"><?php _e('Try to load data from existing customer', 'wp_all_import_plugin') ?></label>
				...
				<span class="wpallimport-slide-content" style="padding-left:0;">
					<div class="wpallimport-billing-user-try-match">
						<div class="wpallimport-billing-user-try-match-selector">
							<label for=""><?php _e('Match by:', 'wpai_woocommerce_addon_plugin'); ?></label>
							<select name="pmwi_order[billing_source_match_by]" id="billing_source_match_by" class="rad4">
								<option value="username" <?php echo 'username' == $post['pmwi_order']['billing_source_match_by'] ? 'selected="selected"' : '' ?>><?php _e('Username', 'wp_all_import_plugin'); ?></option>
								<option value="email" <?php echo 'email' == $post['pmwi_order']['billing_source_match_by'] ? 'selected="selected"' : '' ?>><?php _e('Email', 'wp_all_import_plugin'); ?></option>
								<option value="cf" <?php echo 'cf' == $post['pmwi_order']['billing_source_match_by'] ? 'selected="selected"' : '' ?>><?php _e('Custom Field', 'wp_all_import_plugin'); ?></option>
								<option value="id" <?php echo 'id' == $post['pmwi_order']['billing_source_match_by'] ? 'selected="selected"' : '' ?>><?php _e('User ID', 'wp_all_import_plugin'); ?></option>
							</select>
						</div>
						<div class="clear"></div>
						...
						<div class="form-field wpallimport-radio-field wpallimport-select-switcher-target" rel="username">
							...
							<div class="switcher-target-billing_source_match_by_username set_with_xpath">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									<input type="text" class="short rad4" name="pmwi_order[billing_source_username]" style="" value="<?php echo esc_attr($post['pmwi_order']['billing_source_username']) ?>" placeholder="<?php _e('Username', 'wp_all_import_plugin'); ?>"/>
								</span>
							</div>
						</div>
						<div class="clear"></div>
						...
						<div class="form-field wpallimport-radio-field wpallimport-select-switcher-target" rel="email">
							...
							<div class="switcher-target-billing_source_match_by_email set_with_xpath">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									<input type="text" class="short rad4" name="pmwi_order[billing_source_email]" style="" value="<?php echo esc_attr($post['pmwi_order']['billing_source_email']) ?>" placeholder="<?php _e('Email Address', 'wp_all_import_plugin'); ?>"/>
								</span>
							</div>
						</div>
						<div class="clear"></div>
						...
						<div class="form-field wpallimport-radio-field wpallimport-select-switcher-target" rel="cf">
							...
							<div class="switcher-target-billing_source_match_by_cf set_with_xpath">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									<p style="padding: 0;">
										<input type="text" class="short rad4" name="pmwi_order[billing_source_cf_name]" style="" value="<?php echo esc_attr($post['pmwi_order']['billing_source_cf_name']) ?>" placeholder="<?php _e('Field Name', 'wp_all_import_plugin'); ?>"/>
									</p>
									<p style="padding: 0;">
										<input type="text" class="short rad4" name="pmwi_order[billing_source_cf_value]" style="" value="<?php echo esc_attr($post['pmwi_order']['billing_source_cf_value']) ?>" placeholder="<?php _e('Field Value', 'wp_all_import_plugin'); ?>"/>
									</p>
								</span>
							</div>
						</div>
						...
						<div class="form-field wpallimport-radio-field wpallimport-select-switcher-target" rel="id">
							...
							<div class="switcher-target-billing_source_match_by_id set_with_xpath">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									<input type="text" class="short rad4" name="pmwi_order[billing_source_id]" style="" value="<?php echo esc_attr($post['pmwi_order']['billing_source_id']) ?>" placeholder="<?php _e('User ID', 'wp_all_import_plugin'); ?>"/>
								</span>
							</div>
						</div>
						<div class="form-field wpallimport-radio-field">
							...
							<label for="billing_is_guest_matching" style="width:auto;"><?php _e('If no match found, import as guest customer', 'wp_all_import_plugin') ?></label>
							<span class="wpallimport-clear"></span>
							...
							<p class="is_guest_matching_notice" style="padding: 5px 0 10px;"><i><?php _e('Orders without a match will be skipped', 'wp_all_import_plugin'); ?></i></p>
						</div>
					</div>
				</span>																	
			</div>
		...
		<div style="margin-top:0; padding-left:8px;">
			<div class="form-field wpallimport-radio-field">
				...
				<label for="billing_source_guest" style="width:auto;"><?php _e('Import as guest customer', 'wp_all_import_plugin') ?></label>
			</div>
			<span class="wpallimport-clear"></span>
