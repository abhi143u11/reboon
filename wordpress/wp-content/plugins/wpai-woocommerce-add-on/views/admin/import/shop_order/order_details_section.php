							...
							<div class="input">
								...
								<div class="switcher-target-order_status" style="margin-top:10px;">
									<span class="wpallimport-slide-content" style="padding-left:0;">
										...
										<a href="#help" class="wpallimport-help" title="<?php printf(__('Order status can be matched by title or slug: %s. If order status is not found \'Pending Payment\' will be applied to order.', 'wp_all_import_plugin'), implode(", ", $statuses_for_tooltip)); ?>" style="position:relative; top:-2px;">?</a>
									</span>
								</div>								
							</div>	
						</td>
