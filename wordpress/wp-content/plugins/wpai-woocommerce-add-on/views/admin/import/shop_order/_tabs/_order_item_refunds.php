<div class="panel woocommerce_options_panel" id="order_refunds" style="display:none;">
	<div class="options_group hide_if_grouped">																						
		<table class="form-field" style="width:98%;" cellspacing="5">															
			<tr>
				<td>
					<label><?php _e('Refund Amount', 'wp_all_import_plugin'); ?></label>
					<div class="clear">
				...
				<td>
					<label><?php _e('Reason', 'wp_all_import_plugin'); ?></label>
					<div class="clear">
			...
			<tr>
				<td colspan="2">
					<label><?php _e('Date', 'wp_all_import_plugin'); ?></label>
					<div class="clear">
					...
					<label style="padding-top:10px;"><?php _e('Refund Issued By', 'wp_all_import_plugin'); ?></label>															
					<div class="clear" style="margin-top:0;">
						<div class="wpallimport-radio-field">
							...
							<label for="order_refund_issued_source_existing" style="width:auto;"><?php _e('Load details from existing user', 'wp_all_import_plugin') ?></label>																				
							<a href="#help" class="wpallimport-help" title="<?php _e('If no user is matched, refund issuer will be left blank.', 'wp_all_import_plugin') ?>" style="position:relative; top: 3px;">?</a>
						</div>
						<span class="wpallimport-clear"></span>
						<div class="switcher-target-order_refund_issued_source_existing" style="padding-left:7px;">				
							<span class="wpallimport-slide-content" style="padding-left:0;">
								...
								<div class="form-field wpallimport-radio-field">
									...
									<label for="order_refund_issued_match_by_username"><?php _e('Username', 'wp_all_import_plugin') ?></label>		
									<span class="wpallimport-clear"></span>
								...
								<div class="form-field wpallimport-radio-field">
									...
									<label for="order_refund_issued_match_by_email"><?php _e('Email', 'wp_all_import_plugin') ?></label>			
									<span class="wpallimport-clear"></span>
								...
								<div class="form-field wpallimport-radio-field">
									...
									<label for="order_refund_issued_by_cf"><?php _e('Custom Field', 'wp_all_import_plugin') ?></label>			
									<span class="wpallimport-clear"></span>
								...
								<div class="form-field wpallimport-radio-field">
									...
									<label for="order_refund_issued_by_id"><?php _e('User ID', 'wp_all_import_plugin') ?></label>			
									<span class="wpallimport-clear"></span>
					...
					<div style="margin-top:0;">
						<div class="wpallimport-radio-field">
							...
							<label for="order_refund_issued_source_blank" style="width:auto;"><?php _e('Leave refund issuer blank', 'wp_all_import_plugin') ?></label>	
						</div>
					</div>
