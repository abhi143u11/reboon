<div class="panel woocommerce_options_panel" id="order_coupons" style="display:none;">
	<div class="options_group hide_if_grouped">
		...
		<!-- <div class="form-field wpallimport-radio-field wpallimport-clear">
			...
			<label for="coupons_repeater_mode_fixed" style="width:auto;"><?php _e('Fixed Repeater Mode', 'wp_all_import_plugin') ?></label>						
		</div>	 -->		
		<table class="form-field wpallimport_variable_table" style="width:98%;">
				...
				<tr class="form-field">
					<td>
						<table style="width:100%;" cellspacing="5">
							<tr>
								<td colspan="2">
									<label><?php _e('Coupon Code', 'wp_all_import_plugin'); ?></label>
									<div class="clear">
							...
							<tr>
								<td>
									<label><?php _e('Discount Amount', 'wp_all_import_plugin'); ?></label>
									<div class="clear">
								...
								<td>
									<label><?php _e('Discount Amount Tax', 'wp_all_import_plugin'); ?></label>
									<div class="clear">
			...
			<tr class="wpallimport-row-actions" style="display:none;">
				<td colspan="2">					
					<a class="add-new-line" title="Add Another Coupon" href="javascript:void(0);" style="width:200px;"><?php _e("Add Another Coupon", "wp_all_import_plugin"); ?></a>
				</td>
			</tr>
		</table>
	</div>	
			...
			<div style="padding: 0px;" class="wpallimport-collapsed-content">										
				<div class="wpallimport-collapsed-content-inner">
					...
					<div class="form-field wpallimport-radio-field wpallimport-clear">
						...
						<label for="coupons_repeater_mode_variable_csv" style="width:auto; float: none;"><?php _e('Fixed Repeater Mode', 'wp_all_import_plugin') ?></label>	
						<div class="switcher-target-coupons_repeater_mode_variable_csv wpallimport-clear" style="padding: 10px 0 10px 25px; overflow: hidden;">
							<span class="wpallimport-slide-content" style="padding-left:0;">	
								<label class="order-separator-label" style="line-height: 30px;"><?php _e('Multiple coupons separated by', 'wp_all_import_plugin'); ?></label>						
					...
					<div class="form-field wpallimport-radio-field wpallimport-clear">
						...
						<label for="coupons_repeater_mode_variable_xml" style="width:auto; float: none;"><?php _e('Variable Repeater Mode', 'wp_all_import_plugin') ?></label>
