		...
		<table class="form-table" style="max-width:none;">
			<tr>
				<td>																				
					...
					<div class="form-field">
						<p class="form-field"><?php _e('Payment Method', 'wpai_woocommerce_addon_plugin') ?></p>
						<div class="form-field">
							<select id="payment_method" name="pmwi_order[payment_method]" style="width: 200px; font-size: 14px !important;" class="switcher rad4">
								...
								?>
								<option value="xpath" <?php if ("xpath" == $post['pmwi_order']['payment_method']) echo 'selected="selected"';?>><?php _e("Set with XPath", "wpai_woocommerce_addon_plugin"); ?></option>
							</select>				
							...
							<div class="switcher-target-payment_method" style="margin-top:10px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<a href="#help" class="wpallimport-help" title="<?php printf(__('Payment method can be matched by title or slug: %s. If payment method is not found \'N/A\' will be applied to order.', 'wp_all_import_plugin'), implode(", ", $payment_gateways_for_tooltip)); ?>" style="position:relative; top:10px;">?</a>
								</span>
							</div>
						</div>												
					</div>	
			...
			<tr>
				<td>
					<div class="form-field">
						<div class="form-field">
							<label><?php _e('Transaction ID', 'wp_all_import_plugin'); ?></label>
							<div class="clear">
