<?php
$output = $title = $portfolio_layout = $columns = $view = $info_view = $thumb_bg = $thumb_image = $cat = $cats = $post_in = $number = $view_more = $view_more_class = $filter = $pagination = $animation_type = $animation_duration = $animation_delay = $ajax_load = $ajax_modal = $el_class = '';
...
if ($posts->have_posts()) {
    ...
    <?php if (isset($porto_settings['portfolio-archive-link-zoom']) && $porto_settings['portfolio-archive-link-zoom']) : ?><div class="portfolios-lightbox"><?php endif; ?>
