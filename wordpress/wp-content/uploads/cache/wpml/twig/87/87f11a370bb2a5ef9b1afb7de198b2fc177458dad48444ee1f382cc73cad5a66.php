...
/* store-pages.twig */
class __TwigTemplate_8711738b228c09ff2bf4bbba2d54f1df0a957b1e361d3903b4b64158c6bfc67e extends Twig_Template
{
    ...
    <div class=\"wcml-section-header\">
        <h3>
            ";
        // line 4
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "store_pages", array()), "html", null, true);
        echo "
            <i class=\"otgs-ico-help wcml-tip\" data-tip=\"";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "pages_trnsl", array()));
        echo "\"></i>
        </h3>
    </div>
    <div class=\"wcml-section-content\">
        <ul class=\"wcml-status-list\">
            ";
        // line 10
        if (((isset($context["miss_lang"]) ? $context["miss_lang"] : null) == "non_exist")) {
            // line 11
            echo "                <li>
                    <i class=\"otgs-ico-warning\"></i>
                    ";
            // line 13
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "not_created", array()), "html", null, true);
            echo "
                </li>
                <li>
                    <a href=\"";
            // line 16
            echo twig_escape_filter($this->env, (isset($context["install_link"]) ? $context["install_link"] : null), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "install", array()), "html", null, true);
            echo "</a>
                </li>
            ";
        } elseif (        // line 18
(isset($context["miss_lang"]) ? $context["miss_lang"] : null)) {
            // line 19
            ...
            echo "\">
                    ";
            // line 20
            echo $this->getAttribute((isset($context["nonces"]) ? $context["nonces"] : null), "create_pages", array());
            echo "
                    <input type=\"hidden\" name=\"create_missing_pages\" value=\"1\"/>

                    ";
            // line 23
            if ($this->getAttribute((isset($context["miss_lang"]) ? $context["miss_lang"] : null), "lang", array(), "any", true, true)) {
                // line 24
                echo "                        <li>
                            <i class=\"otgs-ico-warning\"></i>
                            ";
                // line 26
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "not_exist", array()), "html", null, true);
                echo "
                            <ul class=\"wcml-lang-list\">
                                ";
                // line 28
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["miss_lang"]) ? $context["miss_lang"] : null), "lang", array()));
                ...
                echo "                            </ul>
                            ...
                            <button class=\"button-secondary aligncenter\" type=\"submit\" name=\"create_pages\">
                                ";
                // line 39
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "create_transl", array()), "html", null, true);
                echo "
                            </button>
                        </li>
                    ";
            ...
            echo "
                    ";
            // line 44
            if ($this->getAttribute((isset($context["miss_lang"]) ? $context["miss_lang"] : null), "in_progress", array(), "any", true, true)) {
                // line 45
                echo "                        <li>
                            <i class=\"otgs-ico-in-progress\"></i>
                            ";
                // line 47
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "translated_wpml", array()), "html", null, true);
                echo "
                            <ul class=\"wcml-lang-list\">
                                ";
                // line 49
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["miss_lang"]) ? $context["miss_lang"] : null), "in_progress", array()));
            ...
            echo "                <li>
                    ...
                    ";
            // line 71
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "translated", array()), "html", null, true);
            echo "
                </li>
            ";
        }
    ...
    {
        return new Twig_Source("", "store-pages.twig", "/html/wordpress/wp-content/plugins/woocommerce-multilingual/templates/status/store-pages.twig");
    }
}
