...
/* store-urls.twig */
class __TwigTemplate_326d7e79fbd644cd2ef5c855213af7c4b24ada584f45cffd041d54c59b89c5cd extends Twig_Template
{
...
\t\t\t\t\t\t</span>
    ...
    <tbody>
        ...
        echo "        ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["attribute_slugs"]) ? $context["attribute_slugs"] : null));
            ...
            echo "            <tr>
                <td>
                    <strong>
                        ";
            // line 128
            echo twig_escape_filter($this->env, sprintf($this->getAttribute((isset($context["strings"]) ? $context["strings"] : null), "attribute_slug", array()), $this->getAttribute($context["slug"], "label", array())), "html", null, true);
            echo "
                    </strong>
                </td>
...
";
    ...
    {
        return new Twig_Source("", "store-urls.twig", "/html/wordpress/wp-content/plugins/woocommerce-multilingual/templates/store-urls/store-urls.twig");
    }
}
